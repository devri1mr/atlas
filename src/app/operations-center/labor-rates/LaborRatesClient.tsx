            ...
            <div className="flex items-center gap-2">
              ...
              <Dialog.Root open={addOpen} onOpenChange={setAddOpen}>
                ...
                <Dialog.Portal>
                  ...
                  <Dialog.Content className="fixed left-1/2 top-1/2 z-[9999] w-[92vw] max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-x1 bg-white p-5 shadow-2x1 focus:outline-none">
