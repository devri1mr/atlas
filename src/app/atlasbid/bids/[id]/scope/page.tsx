            ...
            <div className="px-5 py-5 space-y-4">
              ...
              {labor.length === 0 ? (
                ...
                <table className=”w-full text-sm”>
                  ...
                  <thead>
                    <tr>
                      <th className=”text-xs font-semibold text-gray-500 uppercase tracking-wide pb-2 border-b text-center”>Show</th>
                      ...
                      <th className=”text-xs font-semibold text-gray-500 uppercase tracking-wide pb-2 border-b text-right”>Qty</th>
                      <th className=”text-left text-xs font-semibold text-gray-500 uppercase tracking-wide pb-2 border-b”>Unit</th>
                      <th className=”text-xs font-semibold text-gray-500 uppercase tracking-wide pb-2 border-b text-right”>Hours</th>
                      <th className=”text-xs font-semibold text-gray-500 uppercase tracking-wide pb-2 border-b text-right”>Total</th>
                      <th className=”text-xs font-semibold text-gray-500 uppercase tracking-wide pb-2 border-b text-right”>Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    {laborGroups.map((g) => {
