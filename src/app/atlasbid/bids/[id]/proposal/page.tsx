...
export default async function BidProposalPage({
  params,
}: {
  ...
  return (
    <div>
      <h2 className="text-xl font-semibold text-[#123b1f]">Proposal</h2>
      <p className="mt-2 text-sm text-[#3d5a45]">
        Client-facing scope + pricing + copy-to-SAP will live here.
      </p>
