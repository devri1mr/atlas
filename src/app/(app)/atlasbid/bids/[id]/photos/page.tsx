              ...
              {filtered.map(photo => {
                ...
                return (
                  <div key={photo.id}
                    ...
                    {/* Tag badges */}
                    {photo.tags?.length > 0 && (
                      <div className="absolute bottom-8 left-0 right-0 p-1.5 flex flex-wrap gap-1">
                    ...
                    <button onClick={e => { e.stopPropagation(); setEditing(photo); }}
                      className="absolute bottom-0 left-0 right-0 flex items-center justify-center gap-1.5 py-2 bg-[#16a34a]/90 text-white text-xs font-semibold hover:bg-[#15803d] transition-colors"
                      title="Edit photo">
