              ...
              {filtered.map(photo => {
                ...
                return (
                  <div key={photo.id}
                    ...
                    <button onClick={e => { e.stopPropagation(); setEditing(photo); }}
                      className="absolute bottom-1.5 right-1.5 flex items-center gap-1 px-2 py-1 rounded-lg bg-black/60 text-white text-[10px] font-semibold hover:bg-[#123b1f] transition-colors"
                      title="Edit photo">
                      <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                      Edit
                    </button>
                    {/* Delete btn */}
