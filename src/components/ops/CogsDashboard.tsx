                      ...
                      {MONTHS.map((m, i) => {
                        ...
                        return (
                          <th
                            ...
                            style={{ background: isCurr ? "rgba(254,249,195,0.15)" : BG, minWidth: 52, opacity: future ? 0.4 : 1, borderRight: "1px solid rgba(255,255,255,0.15)", borderBottom: isCurr ? "2px solid rgba(254,249,195,0.5)" : "2px solid rgba(255,255,255,0.15)" }}
                          >
                            <span className={`font-bold uppercase tracking-wider ${isCurr ? "text-sm text-yellow-200" : "text-xs text-white/70"}`}>{m}</span>
                          </th>
                        );
                      })}
