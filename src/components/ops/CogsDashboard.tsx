                      ...
                      {MONTHS.map((m, i) => {
                        ...
                        return (
                          <th
                            ...
                            style={{ background: isCurr ? "#fefce8" : BG, minWidth: 52, opacity: future ? 0.4 : 1, borderRight: "1px solid rgba(255,255,255,0.15)", borderBottom: "2px solid rgba(255,255,255,0.15)" }}
                          >
