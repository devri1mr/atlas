...
const NAV: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Roster",        href: "/operations-center/atlas-time/employees",  permKey: "hr_team_view" },
      { label: "Punch Log",     href: "/operations-center/atlas-time/clock",       permKey: "hr_manager" },
      { label: "Kiosk",         href: "/operations-center/atlas-time/punch",       permKey: "hr_kiosk" },
      ...
      { label: "Settings",      href: "/operations-center/atlas-time/settings",    permKey: "hr_settings" },
    ],
  },
  {
    label: "Users",
